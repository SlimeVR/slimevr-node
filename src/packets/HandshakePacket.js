...
module.exports = class HandshakePacket extends Packet {
  ...
  toString() {
    return `HandshakePacket{boardType: ${this.boardType}, imuType: ${this.imuType}, mcuType: ${this.mcuType}, firmwareBuild: ${this.firmwareBuild}, firmware: ${this.firmware}, mac: ${this.mac}}`;
  }
};
